      ...
      messages: [
        {
          ...
          [🔥 절대 지켜야 할 필수 규칙 3: 다채로운 시간의 부여]
          "YYYY년 MM월 DD일 HH시 mm분 날씨: [시적인 날씨]" 형식의 'title'을 지어주세요.
          - YYYY년: 1850년부터 2100년 사이에서 무작위성에 기반해 폭넓게 선택하세요. (과거의 향수부터 미래의 희망까지 다양하게 부여하되 특정 연도 편중 금지)
          - MM월, HH시: 답변의 분위기와 에너지에 따라 1~12월, 0~23시를 고르게 활용하세요.
